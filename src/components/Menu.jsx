...
export default function Menu({ src, projects }) {
    ...
    >
      ...
      >
        <div className="px-18 py-7 flex items-center">
          <div className="flex flex-1">
            <AnimatedLink
              ...
              hoverText="Curating Contemporary Culture"
              url="/"
            />
          </div>
        ...
        <motion.div
          ...
          className="bg-red-300_ flex-grow"
        >
          <div className="grid grid-cols-24 gap-4 h-full px-18">
            ...
            <div className="menu-links col-start-17 col-span-full bg-emerald-100_ relative">
              <div className=" flex flex-col gap-1 font-mono text-3xl">
                ...
                <Link href="/studios" onClick={handleClose}>
                  Design Studios
                </Link>
              ...
              <div className="flex flex-col gap-1 mt-8 text-xs">
                ...
                <Link href="/become-a-patron" onClick={handleClose}>
                  Become a patron
                </Link>
              </div>
              <div className="flex flex-col gap-1 mt-8 text-xs">
              ...
              <div className=" absolute bottom-0 pb-16 w-full">
                ...
                <div className="flex gap-4">
                  <div className="flex-1">
                    <input
                      type="text"
                      className="border border-md-black bg-md-grey-100 text-base w-full p-2"
                    />
                  </div>
                  <div>
  ...
  return (
    <>
      ...
      >
        <Image src="/icon-menu.svg" width={24} height={24} alt="Search" />
      </button>
