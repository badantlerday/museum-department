	...
	return (
		<>
			...
			{/* <motion.section
				...
				viewport={{ once: true }}
				key={`splash-${project.slug.current}`}
			>
			...
			<motion.section
				...
				viewport={{ once: true }}
				key={`content-${project.slug.current}`}
			>
				<div className="px-6 md:px-20 grid md:grid-cols-6 md:gap-10 items-start">
					...
					<div className="col-span-2 article order-1 md:order-none mb-10 md:mb-0 md:sticky md:top-24">
						<p>
