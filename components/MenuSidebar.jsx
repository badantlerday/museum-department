...
export default function MenuSidebar({ src }) {
  ...
  const lightboxContent = (
    <div
      className={`fixed inset-0 bg-black bg-opacity-80 flex z-50 duration-200 ${isVisible ? "opacity-1" : "opacity-0 delay-200"}`}
      onClick={handleClose}
    >
      <div
        className={`flex flex-col max-h-full max-w-[100vw] min-w-[100vw] _lg:max-w-[700px] _lg:min-w-[700px] bg-md-grey-100 absolute  top-0 right-0 bottom-0 duration-300 ${isVisible ? "translate-y-[0%] delay-200" : "-translate-y-[100%] delay-0"}`}
      ...
      >
        ...
        <div className="grid grid-cols-24 gap-4">
          <div className=" col-start-16 col-span-full">
