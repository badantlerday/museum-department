...
export default function Header() {
	return (
		<header className="backdrop-blur-md bg-white/10 fixed top-0 left-0 w-full z-50">
			<nav
			...
			>
				<div className="flex lg:flex-1 text-sm space-x-4 items-center font-medium">
					{/* <div className="bg-black text-white rounded p-3 inline-block">
						On Display
					</div> */}
					<Link href="/" className="bg-slate-100_ py-2_ px-3_ rounded-sm_">
						On Display
					</Link>
					<Link href="/fonts-in-use">Fonts In Use</Link>
					<Link href="/fonts-in-use">Studios</Link>
					<Link href="/fonts-in-use">Archive</Link>
				</div>
				<div className="hidden lg:flex lg:gap-x-12 text-sm uppercase font-medium tracking-wide">
					<Link href="/">Museum Department</Link>
				</div>
